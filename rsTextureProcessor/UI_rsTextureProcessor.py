...
#
# Created: Thu Mar 02 17:21:09 2017
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cB_swapToRS = QtGui.QCheckBox(self.gB_sourceShd)
        self.cB_swapToRS.setGeometry(QtCore.QRect(10, 50, 161, 17))
        self.cB_swapToRS.setObjectName("cB_swapToRS")
        self.pB_toNonRS = QtGui.QPushButton(self.gB_sourceShd)
        self.pB_toNonRS.setGeometry(QtCore.QRect(50, 70, 75, 23))
        self.pB_toNonRS.setObjectName("pB_toNonRS")
        self.pB_toRS = QtGui.QPushButton(self.gB_sourceShd)
        self.pB_toRS.setGeometry(QtCore.QRect(140, 70, 75, 23))
        self.pB_toRS.setObjectName("pB_toRS")
        ...
        #elf.gB_extra = QtGui.QGroupBox(self.tabWid_filter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cB_swapToRS.setText(QtGui.QApplication.translate("MainWindow", "Swap to rsxbin after convert", None, QtGui.QApplication.UnicodeUTF8))
        self.pB_toNonRS.setText(QtGui.QApplication.translate("MainWindow", "to non rs", None, QtGui.QApplication.UnicodeUTF8))
        self.pB_toRS.setText(QtGui.QApplication.translate("MainWindow", "to rs", None, QtGui.QApplication.UnicodeUTF8))
