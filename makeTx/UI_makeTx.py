...
# Form implementation generated from reading ui file 'C:\Users\mnhan\Documents\maya\pythonScript\UI_makeTx_v03.ui'
#
# Created: Fri Apr 29 12:30:56 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(0, 0, 281, 431))
        ...
        self.cB_overwrite.setGeometry(QtCore.QRect(11, 19, 91, 20))
        self.cB_overwrite.setObjectName("cB_overwrite")
        self.pB_deleteTx = QtGui.QPushButton(self.gB_overwrite)
        self.pB_deleteTx.setGeometry(QtCore.QRect(130, 14, 121, 31))
        self.pB_deleteTx.setObjectName("pB_deleteTx")
        self.tabWid = QtGui.QTabWidget(self.frame)
        self.tabWid.setEnabled(True)
        self.tabWid.setGeometry(QtCore.QRect(10, 10, 261, 141))
        ...
        self.gB_sourceShd.setGeometry(QtCore.QRect(0, 10, 261, 101))
        ...
        self.cB_swapToTx = QtGui.QCheckBox(self.gB_sourceShd)
        self.cB_swapToTx.setGeometry(QtCore.QRect(10, 40, 231, 20))
        self.cB_swapToTx.setObjectName("cB_swapToTx")
        self.pB_toTx = QtGui.QPushButton(self.gB_sourceShd)
        self.pB_toTx.setGeometry(QtCore.QRect(150, 60, 101, 31))
        self.pB_toTx.setObjectName("pB_toTx")
        self.pB_toNonTx = QtGui.QPushButton(self.gB_sourceShd)
        self.pB_toNonTx.setGeometry(QtCore.QRect(50, 60, 91, 31))
        self.pB_toNonTx.setObjectName("pB_toNonTx")
        self.pB_selTarget = QtGui.QPushButton(self.gB_sourceShd)
        self.pB_selTarget.setGeometry(QtCore.QRect(164, 20, 71, 21))
        self.pB_selTarget.setObjectName("pB_selTarget")
        self.tabWid.addTab(self.tabWid_maya, "")
        self.tabWid_options = QtGui.QTabWidget(self.frame)
        self.tabWid_options.setEnabled(True)
        self.tabWid_options.setGeometry(QtCore.QRect(10, 210, 261, 211))
        ...
        self.pB_doMakeTx = QtGui.QPushButton(self.tabWid_makeTx)
        self.pB_doMakeTx.setGeometry(QtCore.QRect(10, 130, 241, 41))
        ...
        self.gB_extra.setGeometry(QtCore.QRect(0, 10, 261, 101))
        ...
        self.lE_suffix.setGeometry(QtCore.QRect(70, 20, 181, 21))
        ...
        self.pB_goOiio = QtGui.QPushButton(self.tabWid_filter)
        self.pB_goOiio.setGeometry(QtCore.QRect(20, 130, 231, 41))
        ...
        self.ac_aboutMakeTx = QtGui.QAction(MainWindow)
        ...
        self.tabWid_options.setCurrentIndex(2)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QtGui.QApplication.translate("MainWindow", "Make Tx", None, QtGui.QApplication.UnicodeUTF8))
        self.gB_overwrite.setTitle(QtGui.QApplication.translate("MainWindow", "Removal", None, QtGui.QApplication.UnicodeUTF8))
        self.cB_overwrite.setText(QtGui.QApplication.translate("MainWindow", "Overwrite?", None, QtGui.QApplication.UnicodeUTF8))
        self.pB_deleteTx.setText(QtGui.QApplication.translate("MainWindow", "Delete Tx", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.cB_swapToTx.setText(QtGui.QApplication.translate("MainWindow", "Swap to tx after convert", None, QtGui.QApplication.UnicodeUTF8))
        self.pB_toTx.setText(QtGui.QApplication.translate("MainWindow", " to tx", None, QtGui.QApplication.UnicodeUTF8))
        self.pB_toNonTx.setText(QtGui.QApplication.translate("MainWindow", "to non tx", None, QtGui.QApplication.UnicodeUTF8))
        self.pB_selTarget.setText(QtGui.QApplication.translate("MainWindow", "select target", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.gB_makeTxBinary.setTitle(QtGui.QApplication.translate("MainWindow", "maketx binary", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pB_doMakeTx.setText(QtGui.QApplication.translate("MainWindow", "Go tx", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWid_options.setTabText(self.tabWid_options.indexOf(self.tabWid_makeTx), QtGui.QApplication.translate("MainWindow", "MakeTx", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.ac_aboutMakeTx.setText(QtGui.QApplication.translate("MainWindow", "About Maketx", None, QtGui.QApplication.UnicodeUTF8))
